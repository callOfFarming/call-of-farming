var bigCommands = {
  ...
  "current task": () => {
    if (game.currentTask) {
      ...
      if (task) {
        ai.speak(
          `You are currently ${task.name}. You will be done ${moment(
      ...
      ai.speak(
        `You are not currently doing anything, say "list tasks" to get a list of tasks you can currently do. Duh.`
      );
    }
  },
  "current date": () => {
